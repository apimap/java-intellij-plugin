...
public class ApimapTaxonomyDataAttributeOptionImpl extends ASTWrapperPsiElement implements ApimapTaxonomyDataAttributeOption {

  public ApimapTaxonomyDataAttributeOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ApimapTaxonomyVisitor visitor) {
    visitor.visitDataAttributeOption(this);
  }
