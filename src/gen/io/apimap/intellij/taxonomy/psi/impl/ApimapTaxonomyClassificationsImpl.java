...
public class ApimapTaxonomyClassificationsImpl extends ASTWrapperPsiElement implements ApimapTaxonomyClassifications {

  public ApimapTaxonomyClassificationsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ApimapTaxonomyVisitor visitor) {
    visitor.visitClassifications(this);
  }
