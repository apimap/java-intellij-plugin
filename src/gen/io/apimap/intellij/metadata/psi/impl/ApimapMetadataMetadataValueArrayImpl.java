...
public class ApimapMetadataMetadataValueArrayImpl extends ASTWrapperPsiElement implements ApimapMetadataMetadataValueArray {

  public ApimapMetadataMetadataValueArrayImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ApimapMetadataVisitor visitor) {
    visitor.visitMetadataValueArray(this);
  }
